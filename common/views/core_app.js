...
{
    $('#entitylist tr.info').attr("class","active");
    $(this).attr("class","info");
});
...
{
    var curcol = this.id;
    $('#tablehead tr').find('th.info').attr("class","active");
    $('#tablehead tr').find('th#'+curcol).attr("class","info");
    $('div.ivalue-block').hide();
});

$('body').on('click','#modallist td',function () 
{
    var curcol = this.id;
    $('#modallist th.info').attr("class","active");
    $('#modallist').find('th#'+curcol).attr("class","info");
});
