...
$('input.form-control').keyup(function(eventObject) { 
    ...
    else 
    {
        ...
        {
           $.getJSON(
                '/app/components/utils/uploadobject/uploadobject_ajax.php',
                $data,
                onLoadGetData
            );
        }
...
function show_uploadfile($data)
{
    ...
    $data = $('.row input').serializeArray();
    $.ajax({
      url: '/app/components/utils/uploadobject/uploadobject_ajax.php',
      type: 'post',
      dataType: 'json',
      data: $data,
      success: function(result) {
...
$('body').on('click', '#build', function (e) 
{
    ...
    if (filename!=='')
    {
        ...
        // Отправка на сервер
        $.ajax({
            url: '/app/components/utils/uploadobject/uploadobject_uploadfile.php',
            data: formdata,
            type: 'POST',
            dataType: 'json',
            processData: false,
